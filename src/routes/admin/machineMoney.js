...
const connectComponent = createContainer(
  ({ machineMoney }) => ({ machineMoney }), // mapStateToProps
...
export default {
  ...
  getComponent (nextState, cb) {
    require.ensure([], (require) => {
      // 立即注入 Reducer
      injectReducer('machineMoney', require('REDUCER/Admin/home/homeReducer').default)

      cb(null, connectComponent(require('VIEW/admin/machinemoney').default))
    }, 'machineMoneyView')
  },
