...
const connectComponent = createContainer(
  ({ user, userData }) => ({ user, userData }), // mapStateToProps
  require('ACTION/Admin/user/userAction').default               // mapActionCreators
)
...
export default {
  ...
  getComponent (nextState, cb) {
    require.ensure([], (require) => {
      ...
      cb(null, connectComponent(require('VIEW/admin/user').default))
    }, 'user')
  },
