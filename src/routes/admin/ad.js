...
const connectComponent = createContainer(
  ({ ad }) => ({ ad }), // mapStateToProps
  require('ACTION/Admin/ad/adAction').default               // mapActionCreators
)
...
export default {
  ...
  getComponent (nextState, cb) {
    require.ensure([], (require) => {
      // 立即注入 Reducer
      injectReducer('ad', require('REDUCER/Admin/ad/adReducer').default)

      cb(null, connectComponent(require('VIEW/admin/ad').default))
    }, 'adView')
  },
