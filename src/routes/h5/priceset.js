...
const connectComponent = createContainer(
  ({ priceSet }) => ({ priceSet }), // mapStateToProps
  require('ACTION/Admin/machine/tunnelInfoAction').default               // mapActionCreators
)

export default {
  path: 'priceset/:deviceid',

  /* 布局基页 */
  getComponent (nextState, cb) {
    require.ensure([], (require) => {
      // 立即注入 Reducer
      injectReducer('priceSet', require('REDUCER/Admin/machine/tunnelInfoReducer').default)

      cb(null, connectComponent(require('VIEW/h5/priceset').default))
    }, 'priceSetView')
  },
