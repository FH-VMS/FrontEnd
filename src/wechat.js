...
// 将根组件挂载到 DOM，启动！
// ================================
const MOUNT_NODE = document.getElementById('wechat')
// let childrenRouter = window.location.href.indexOf('admin') == -1 ? routes.main : routes.admin
// children={routes.main}
ReactDOM.render(
  <Provider store={store}>
    <Router history={hashHistory} > 
       <Route path = {routes.wechat.path} component={routes.wechat.component} indexRoute={routes.wechat.indexRoute} childRoutes={routes.wechat.childRoutes} />
    </Router>
  </Provider>,
  MOUNT_NODE
)
