...
// 将根组件挂载到 DOM，启动！
// ================================
const MOUNT_NODE = document.getElementById('hfive')
// let childrenRouter = window.location.href.indexOf('admin') == -1 ? routes.main : routes.admin
// children={routes.main}
ReactDOM.render(
  <Provider store={store}>
    <Router history={hashHistory} > 
       <Route path = {routes.hfive.path} component={routes.hfive.component} indexRoute={routes.hfive.indexRoute} childRoutes={routes.hfive.childRoutes} />
    </Router>
  </Provider>,
  MOUNT_NODE
)
