...
// 将根组件挂载到 DOM，启动！
// ================================
const MOUNT_NODE = document.getElementById('mobile')
// let childrenRouter = window.location.href.indexOf('admin') == -1 ? routes.main : routes.admin
// children={routes.main}
ReactDOM.render(
  <Provider store={store}>
    <Router history={hashHistory} > 
       <Route path = {routes.mobile.path} component={routes.mobile.component} indexRoute={routes.mobile.indexRoute} childRoutes={routes.mobile.childRoutes} />
    </Router>
  </Provider>,
  MOUNT_NODE
)
